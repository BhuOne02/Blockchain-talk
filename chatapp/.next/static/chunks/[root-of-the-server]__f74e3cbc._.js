...
const ChatAppProvider = ({ children })=>{
    ...
    const createAccount = async (name)=>{
        try {
            ...
            setError("error while creating the account.Please Relaod the Browser.");
        }
    };
...
(()=>{
    const e = new Error("Cannot find module 'react/cjs/react.production'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
const Friend = ()=>{
    ...
    const { readMessage, createAccount, addFriend, sendMessage, readUser, account, userName, friendLists, friendMsg, loading, userLists, error, currentUserName, currentUserAddress, setFriendmsg, CheckIfWalletConnected, connectWallet } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useContext"])(__TURBOPACK__imported__module__$5b$project$5d2f$Context$2f$ChatAppContext$2e$js__$5b$client$5d$__$28$ecmascript$29$__["ChatAppContext"]);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {}, void 0, false, {
...
_s(Friend, "8asCavgY7+8CM/4BltbZ8rF2reo=");
_c = Friend;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f74e3cbc._.js.map